...
function chineseZodiac(year){
    ...
    positionAnimal = amount%12;
    zodiacAnimal = animals[positionAnimal];
    positionElement = Math.floor(((amount%10)/2));
    zodiacElement = elements[positionElement];
    
      console.log(positionElement, amount);
